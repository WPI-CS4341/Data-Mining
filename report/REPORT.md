...
The table shows that "centerPlayer", "leftCornerPlayer" and "openMoves" have the most impacts on the decision tree's predictability since they effect the game results more than half time among cross validations.
...
### The tree
  ![Decision tree graph](/screenshots/decision_tree_graph.png)
